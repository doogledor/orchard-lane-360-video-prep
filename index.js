...
const PLAYLIST =
  "https://www.youtube.com/playlist?list=PLZRcgvIPIUuWH9WxuUqV2QEs5S-C63vzx"

const child = spawn(`youtube-dl`, [PLAYLIST, "--flat-playlist", "-J"])
...
DashUpload(IDS, "gs://orchard-lane", { save: __dirname, itags:["266","264","137"] })
